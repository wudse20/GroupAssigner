package se.skorup.util.expression_evaluator.parser;

import se.skorup.util.Log;
import se.skorup.util.collections.ImmutableArray;
import se.skorup.util.expression_evaluator.expression.DefinitionExpression;
import se.skorup.util.expression_evaluator.expression.Division;
import se.skorup.util.expression_evaluator.expression.Expression;
import se.skorup.util.expression_evaluator.expression.IntegerExpression;
import se.skorup.util.expression_evaluator.expression.Minus;
import se.skorup.util.expression_evaluator.expression.Modulo;
import se.skorup.util.expression_evaluator.expression.Multiplication;
import se.skorup.util.expression_evaluator.expression.NumberExpression;
import se.skorup.util.expression_evaluator.expression.ParenthesizedExpression;
import se.skorup.util.expression_evaluator.expression.Plus;
import se.skorup.util.expression_evaluator.expression.Power;
import se.skorup.util.expression_evaluator.expression.UnaryMinus;
import se.skorup.util.expression_evaluator.expression.UnaryPlus;
import se.skorup.util.expression_evaluator.expression.VariableExpression;
...
public class Parser
{
    private final ImmutableArray<SyntaxToken> tokens;
     ...
     * then it will return the next token, else it will return
