...
import se.skorup.gui.callbacks.HoverEffectExit;
...
public class CSVLabel extends JLabel implements MouseListener
{
    ...
    private final List<ActionCallback<CSVLabel>> callbacks = new ArrayList<>();
     ...
     * */
    public void addActionCallback(ActionCallback<CSVLabel> callback)
    {
        if (callback != null)
