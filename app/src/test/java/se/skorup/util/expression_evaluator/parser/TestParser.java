...
public class TestParser
{
    ...
    private static final Environment alwaysZeroEnv = new Environment() {
        @Override
    ...
    private static final Environment cookieEnv = new Environment() {
        @Override
     ...
     * */
    public static TestParserData[] getData()
    {
